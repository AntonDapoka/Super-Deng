...
public class RedWaveOldScript : MonoBehaviour
{/*
    ...
    private void SetMaterialBack(FaceScript FS)
    {
        ...
        /*
        if (FS.FaceState.Get(FaceProperty.HavePlayer)) PS.SetPartsMaterial(materialPlayer); 
        else if (FS.FaceState.Get(FaceProperty.IsRight)) FS.rend.material = FS.materialRightFace;
